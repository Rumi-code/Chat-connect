...
function createClient(): OpenAI {
  ...
  if (!apiKey) throw new Error("No OpenAI API key found. Set OPENAI_API_KEY in your environment secrets.");
  return new OpenAI({ apiKey, ...(baseURL ? { baseURL } : {}) });
}

export const openai = new Proxy({} as OpenAI, {
  get(_target, prop) { return createClient()[prop as keyof OpenAI]; },
});
